...
#	docker buildx build --push --platform linux/arm64/v8,linux/amd64 --tag ghcr.io/nextcloud/context_chat_backend:4.0.1 --tag ghcr.io/nextcloud/context_chat_backend:latest .
...
register:
  ...
  "{\"id\":\"context_chat_backend\",\"name\":\"Context Chat Backend\",\"daemon_config_name\":\"manual_install\",\"version\":\"4.0.1\",\"secret\":\"12345\",\"port\":10034,\"scopes\":[],\"system\":0}" \
